...
export default function ModalCart() {
  ...
  return (
    <div className="picked-product-component">
      ...
      >
        <h2 className="modal-header">Checkout</h2>
        <p ckassName="modal-text"> This is your picked products</p>
        <div>
          <button onClick={() => setModalisOpen(false)}>Close</button>
        </div>
        <ShoppingCart item={items4} />
      </Modal>
    </div>
  );
}
